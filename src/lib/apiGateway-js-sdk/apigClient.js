...
apigClientFactory.newClient = function (config) {
    ...
    var invokeUrl = 'https://u09wgwz7fh.execute-api.us-east-1.amazonaws.com/beta';
    ...
    apigClient.uploadProxyPut = function (params, body, additionalParams) {
        if(additionalParams === undefined) { additionalParams = {}; }
        
        apiGateway.core.utils.assertParametersDefined(params, ['Content-Type', 'proxy'], ['body']);
        
        var uploadProxyPutRequest = {
            verb: 'put'.toUpperCase(),
            path: pathComponent + uritemplate('/upload/{proxy+}').expand(apiGateway.core.utils.parseParametersToObject(params, ['proxy'])),
        ...
        return apiGatewayClient.makeRequest(uploadProxyPutRequest, authType, additionalParams, config.apiKey);
    };
    
    
    apigClient.uploadProxyOptions = function (params, body, additionalParams) {
        if(additionalParams === undefined) { additionalParams = {}; }
        
        apiGateway.core.utils.assertParametersDefined(params, ['Content-Type'], ['body']);
        
        var uploadProxyOptionsRequest = {
            verb: 'options'.toUpperCase(),
            path: pathComponent + uritemplate('/upload/{proxy+}').expand(apiGateway.core.utils.parseParametersToObject(params, [])),
            headers: apiGateway.core.utils.parseParametersToObject(params, ['Content-Type']),
            queryParams: apiGateway.core.utils.parseParametersToObject(params, []),
            body: body
        };
        ...
        return apiGatewayClient.makeRequest(uploadProxyOptionsRequest, authType, additionalParams, config.apiKey);
    };
